...
parser.add_argument(
    ...
    metavar="TRAINSETS",
    nargs="+",
    help="Datasets for training extractors",
)
parser.add_argument(
    "--data.val",
    type=str,
...
parser.add_argument(
    ...
    help="Do classification using cosine similatity between activations and weights",
)
parser.add_argument(
    "--model.dropout",
    type=float,
...
parser.add_argument(
    "--model.pretrained",
    action="store_true",
    help="Using pretrained model for learning or not",
)
...
parser.add_argument(
    "--test.type",
    type=str,
    choices=["standard", "1shot", "5shot", "10shot"],
    default="10shot",
    metavar="LOSS_FN",
...
parser.add_argument(
    "--source", default="", type=str, metavar="PATH", help="path of pretrained model"
)
