...
class BaselineFinetuneAllLayersAdamTest(
    BaselineFinetuneTest, base_test.TestEpisodicLearner
):
...
class BaselineFinetuneAllLayersGDTest(
    BaselineFinetuneTest, base_test.TestEpisodicLearner
):
    learner_cls = optimization_learners.BaselineFinetuneLearner
    learner_kwargs = {
...
class BaselineFinetuneLastLayerGDTest(
    BaselineFinetuneTest, base_test.TestEpisodicLearner
):
    learner_cls = optimization_learners.BaselineFinetuneLearner
    learner_kwargs = {
...
MAML_KWARGS = {
    **base_test.VALID_LEARNER_INIT_ARGS,
    "additional_evaluation_update_steps": 0,
    "first_order": True,
