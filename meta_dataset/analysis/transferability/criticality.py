...
def relative_error_condition(error, reference_error, rtol=1.01):
...
def _interpolate_and_perturb(
    ...
    params = (
        (1 - alpha) * param_init + alpha * param_final
...
def compute_module_criticality(
    ...
    (
        ...
        interpolated_and_perturbed_losses,
        interpolated_and_perturbed_norms,
    ) = tf.map_fn(
    ...
    (loss_final, norm_final, alpha_final, sigma_final) = (
        interpolated_and_perturbed_losses[idx_min],
